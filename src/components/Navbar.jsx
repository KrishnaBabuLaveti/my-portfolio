...
const Navbar = () => {
  ...
  const links = [
    ...
    {
  name: "Internships",
  route: "internship", // ✅ All lowercase to match the div's ID
},
    {
      name: "Projects",
      route: "projects",
      ...
      >
        <div className="flex justify-between items-center py-2 md:py-4 md:px-2 pl-2 mx-auto">
          <div className="flex items-center cursor-pointer">
            <a
  href="/"
  className="text-2xl md:text-2xl lg:text-3xl font-extrabold whitespace-nowrap bg-gradient-to-r from-sky-400 via-sky-500 to-sky-600 bg-clip-text text-transparent tracking-wide"
>
  KRISHNA BABU
</a>
